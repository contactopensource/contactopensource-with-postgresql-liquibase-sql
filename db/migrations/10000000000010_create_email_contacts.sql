...
--changeset contact@contactopensource.com:11
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'email_contacts'
...
CREATE INDEX ix_email_contacts_updated_at_clock_counter on email_contacts(updated_at_clock_counter);
...
--rollback drop table email_contacts;
