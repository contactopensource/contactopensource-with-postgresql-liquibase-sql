...
--changeset contact@contactopensource.com:13
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'postal_contacts'
...
CREATE INDEX ix_postal_contacts_updated_at_clock_counter on postal_contacts(updated_at_clock_counter);
...
--rollback drop table postal_contacts;
