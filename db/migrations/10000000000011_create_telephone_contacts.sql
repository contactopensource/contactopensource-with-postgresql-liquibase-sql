...
--changeset contact@contactopensource.com:12
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'telephone_contacts'
...
CREATE TABLE telephone_contacts (
  ...
  number_text text, -- example: "(415) 555-0000"

  -- E.164-related -- see https://en.wikipedia.org/wiki/E.164
  e164 varchar(15), -- example: "14155550000" means United States country code, San Franicsco area code, etc.
...
CREATE INDEX ix_telephone_contacts_updated_at_clock_counter on telephone_contacts(updated_at_clock_counter);
...
-- E.164-related
CREATE INDEX ix_telephone_contacts_e164 on telephone_contacts(e164);
...
CREATE INDEX ix_telephone_contacts_e164_e164_subscriber_number on telephone_contacts(e164_subscriber_number);

--rollback drop table telephone_contacts;
