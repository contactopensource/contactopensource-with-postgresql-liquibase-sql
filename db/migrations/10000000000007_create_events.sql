...
--changeset contact@contactopensource.com:8
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'events'
...
CREATE TABLE events (
  ...
  duration_as_seconds real -- example: 3600 seconds is 1 hour
...
CREATE INDEX ix_events_updated_at_clock_counter on events(updated_at_clock_counter);
