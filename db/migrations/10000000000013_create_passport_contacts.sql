...
--changeset contact@contactopensource.com:14
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'passport_contacts'
...
CREATE INDEX ix_passport_contacts_updated_at_clock_counter on passport_contacts(updated_at_clock_counter);
...
--rollback drop table passport_contacts;
