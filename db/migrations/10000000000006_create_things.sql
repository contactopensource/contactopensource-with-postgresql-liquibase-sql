...
--changeset contact@contactopensource.com:7
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'things'
...
CREATE INDEX ix_things_updated_at_clock_counter on things(updated_at_clock_counter);
