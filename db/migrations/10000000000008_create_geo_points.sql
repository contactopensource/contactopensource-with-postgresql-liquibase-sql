...
--changeset contact@contactopensource.com:9
--preconditions onFail:HALT onError:HALT
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'geo_points'
...
CREATE INDEX ix_geo_points_updated_at_clock_counter on geo_points(updated_at_clock_counter);
...
--rollback drop table geo_points;
